...
public class JwtUtils {
	...
	/**
	 * Generates a JWT from the given username that does not contains pricing evaluation.
	...
	/**
	 * Extracts the features from a JWT generated by {@link PricingEvaluatorUtil#generateUserToken()} method
	 * @param token a JWT generated by {@link PricingEvaluatorUtil#generateUserToken()} method
	 * @return A Map that contains the evaluation of all the features for the current user located in the JWT body
	 */
	...
	/**
	 * Extracts the plan context from a JWT generated by {@link PricingEvaluatorUtil#generateUserToken()} method
	 * @param token a JWT generated by {@link PricingEvaluatorUtil#generateUserToken()} method
	 * @return A Map that contains the plan context used in the evaluation of features located in the JWT body
	 */
	...
	/**
	 * Extracts the user context from a JWT generated by {@link PricingEvaluatorUtil#generateUserToken()} method
	 * @param token a JWT generated by {@link PricingEvaluatorUtil#generateUserToken()} method
	 * @return A Map that contains the user context used in the evaluation of features located in the JWT body
	 */
	...
	/**
	 * Extracts the username from a JWT generated by {@link PricingEvaluatorUtil#generateUserToken()} method. 
